"""
Django settings for black_morning_40602 project.
...
ROOT_URLCONF = 'black_morning_40602.urls'
...
WSGI_APPLICATION = 'black_morning_40602.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_morning_40602 API",
    "DESCRIPTION": "API documentation for black_morning_40602 App",
    "VERSION": "v1",
}
